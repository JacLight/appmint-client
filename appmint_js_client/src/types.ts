...
export interface Product {
  ...
  calculatedPrice?: { originalPrice?: number; finalPrice?: number; discount?: number; discountPercent?: number };
  [k: string]: unknown;
}
...
export interface CartItemInput {
  ...
  name?: string; price?: number; unitPrice?: number;
...
export interface CartSummary {
  ...
  deposit?: number;
  productSubtotal?: number; productTax?: number; productShipping?: number; productTotal?: number;
  rentalSubtotal?: number; rentalTotal?: number;
  shippingMethod?: string; shippingOptions?: unknown[]; freeShipping?: boolean;
  discounts?: Array<{ code?: string; name?: string; amount?: number; type?: string }>;
  /** False when a coupon was sent and rejected — the total is unchanged. */
  valid?: boolean; reason?: string; message?: string; cartId?: string;
  [k: string]: unknown;
}

export interface ShippingOption {
  label?: string; amount: number; currency?: string;
  service?: string; carrier?: string; freeShipping?: boolean;
  [k: string]: unknown;
}
...
export interface ShippingOptionsResult {
  ...
  currency?: string;
  message?: string;
  problems?: Array<{ config?: string; reason: string }>;
}
